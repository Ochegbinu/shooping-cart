                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 main-col">
                	<form action="#" method="post" class="cart style2">
                		<table>
                    		...
                    		<tbody>
                                ...
                                @foreach ($product as $item)
                                    ...
                                    <td class="cart__price-wrapper cart-flex-item">
                                        <span class="money"><span>&#8358</span> {{$item->price}}</span>
                                    </td>
                                    ...
                                    <td class="text-right small--hide cart-price">
                                        <div><span class="money"><span>&#8358</span> {{$item->price}}</span></div>
                                    </td>
                    		...
                    		<tfoot>
                                <tr>
                                    <td colspan="3" class="text-left"><a href="{{route('index')}}" class="btn--link cart-continue"><i class="icon icon-arrow-circle-left"></i> Continue shopping</a></td>
